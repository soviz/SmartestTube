...
[SmartTube](https://github.com/yuliskov/SmartTube) (a TV/leanback YouTube
...
* docs/VERSIONING.md
  ...
  * SmarterTube product version vs. upstream SmartTube base version scheme
  * Beta/stable/alpha channel policy

* docs/RELEASE_PROCESS.md

  * Release steps and checklist ordering
...
* docs/UPDATER_COMPATIBILITY.md
  ...
  * APK asset naming conventions the updater parses

* docs/FEATURE_MATRIX.md

  * Per-release feature/platform support status

* docs/KNOWN_ISSUES.md

  * Currently known bugs/limitations per release

* docs/upstream-merge.md

  * How upstream SmartTube commits get merged into this fork
  * What must never be edited directly (submodule content) vs. fork-owned
    code
